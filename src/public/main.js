							...
							products.forEach((prod) => {
								$("#ProductAppender").after(`
									<li class="Polaris-ResourceItem__ListItem">											
										<div class="Polaris-Stack Polaris-Stack--alignmentCenter Polaris-Stack--spacingLoose" style="padding: 1.5em">
											<div class="Polaris-Stack__Item">
												<label class="Polaris-Choice Polaris-Choice--labelHidden" for="P${val}${prod.node.id}">
													...
													<span class="Polaris-Choice__Label">choose ${prod.node.title}</span>
												</label>
											</div>
											<div class="Polaris-Stack__Item">
